      ...
      Installation: {
        get: function() {
          if (!this._Installation) {
            ...
            loopback.getModelByType(loopback.Installation);
          }
      ...
      Notification: {
        get: function() {
          if (!this._Notification) {
            ...
            loopback.getModelByType(loopback.PushNotification);
          }
 ...
 */
PushManager.prototype._configureProviders = function() {
  const useFcmForIos = this.settings.useFcmForIos === true;

  PushManager.providers = {
    ios: useFcmForIos ? providers.GcmProvider : providers.ApnsProvider,
